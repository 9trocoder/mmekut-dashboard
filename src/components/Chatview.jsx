  ...
  return (
    <div className="chatview-bar chatview-bar_res">
      <div className="chatviewheader">
        <div className="chatviewheader-left">
          <div className="chatviewheader-left1">
            <div className="rightbarclose" onClick={handlechatviewclose}>
              {closeIcon}
            </div>
            <img src={p1img} alt="" />
          </div>
        ...
        <div className="chatviewheader-right">
          <div className="chatmoreicon">{searchBig}</div>
      ...
      <div className="chatviewwrapper">
        ...
        <Leftchat
          message="Alright i will fix the meeting to the time is okay for everyone. So the meeting would be on google 
meeting or zoom meeting. Please Kindly attend all meeting."
          msgtime="12:00 PM"
        />
      </div>
    </div>
